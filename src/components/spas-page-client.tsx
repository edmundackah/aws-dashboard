...
export function SpasPageClient({ spaData, allTeams }: SpasPageClientProps) {
  const [teamFilter, setTeamFilter] = usePersistentState("spa_teamFilter", "all");
  const [statusFilter, setStatusFilter] = usePersistentState("spa_statusFilter", "all");
  const [globalFilter, setGlobalFilter] = usePersistentState("spa_globalFilter", "");
  ...
  }, [spaData, teamFilter, statusFilter, globalFilter]);
